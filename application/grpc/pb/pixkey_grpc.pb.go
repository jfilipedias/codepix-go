...
const (
	PixService_RegisterPixKey_FullMethodName = "/github.com.jfilipedias.codepix.PixService/RegisterPixKey"
	PixService_FindKeyByKind_FullMethodName  = "/github.com.jfilipedias.codepix.PixService/FindKeyByKind"
)
...
type PixServiceClient interface {
	...
	FindKeyByKind(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error)
}
...
func (c *pixServiceClient) FindKeyByKind(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error) {
	out := new(PixKeyInfo)
	err := c.cc.Invoke(ctx, PixService_FindKeyByKind_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	...
	FindKeyByKind(context.Context, *PixKey) (*PixKeyInfo, error)
...
func (UnimplementedPixServiceServer) FindKeyByKind(context.Context, *PixKey) (*PixKeyInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindKeyByKind not implemented")
}
...
func _PixService_FindKeyByKind_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixKey)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixServiceServer).FindKeyByKind(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PixService_FindKeyByKind_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).FindKeyByKind(ctx, req.(*PixKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.jfilipedias.codepix.PixService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindKeyByKind",
			Handler:    _PixService_FindKeyByKind_Handler,
		},
	},
